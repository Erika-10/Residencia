...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBuilderSelector.setTitle("Selecciona desde tu galeria");
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("address")) {
                        ...
                        mTextInputAddress.setText(mAddress);
                    }
    ...
    private void clickEditProfile() {
        ...
        mAddress = mTextInputAddress.getText().toString();
        if (!mUsername.isEmpty() && !mPhone.isEmpty()&& !mAddress.isEmpty()) {
